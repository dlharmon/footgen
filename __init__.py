...
# convert values from source units into millimeters
def str2mm(dist):
...
if __name__ == "__main__":
    ...
    f = Footgen("testDIP")
    f.pitch = 2.54
    f.drill = str2mm("30 mil")
    f.diameter = str2mm("55 mil")
    f.pins = 8
    f.width = str2mm("0.3 in")
    f.dip()
    f.finish()

    f = Footgen("HEADER_2x6_100mil")
    f.pitch = 2.54
    f.drill = 1.0
    f.diameter = 1.6
    f.pins = 12
